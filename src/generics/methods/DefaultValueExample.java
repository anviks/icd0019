...
public class DefaultValueExample {
    ...
    public void exampleWithHelperForIntegers() {
        ...
        Integer constant = defaultIfNull(getConstantForZone("A"), 1).intValue();

        assertThat(100 * constant, is(200));

        constant = defaultIfNull(getConstantForZone("B"), 1).intValue();
    ...
    public void exampleWithHelperForDoubles() {
        ...
        Double constant = defaultIfNull(getConstantForZoneAsDouble("A"), 1.0).doubleValue();

        assertThat(100 * constant, is(closeTo(200)));

        constant = defaultIfNull(getConstantForZoneAsDouble("B"), 1.0).doubleValue();

        assertThat(100 * constant, is(closeTo(100)));

    }

    public Number defaultIfNull(Number value, Number defaultValue) {
